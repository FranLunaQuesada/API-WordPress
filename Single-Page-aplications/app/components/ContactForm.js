export function ContactForm() {
    ...
    <input type="text" name="name" placeholder="Escribe tu nombre"
      title="El nombre solo acepta letras y espacios en blanco" pattern="^[A-Za-zÑnÁáÉéÍíÓóÚúÜü\\s]+$" required>
    ...
    function validationsForm() {
        ...
        d.addEventListener("submit", e => {
          ...
          fetch("https://formsubmit.co/ajax/franciscoluna962@gmail.com", {
            method: "POST",
